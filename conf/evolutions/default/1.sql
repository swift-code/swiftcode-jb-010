...
alter table connection_request add constraint fk_connection_request_reciever_2 foreign key (reciever_id) references user (id) on delete restrict on update restrict;
create index ix_connection_request_reciever_2 on connection_request (reciever_id);
